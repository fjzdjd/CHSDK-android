package com.chehui.jason.utils;
...
public class NetworkStateManager {
     ...
     * attempting to establish, connectivity with another network. If so, {@code
     ...
     * the broadcast about an alternate network that might be available. If this returns a
     * non-null value, then another broadcast should follow shortly indicating whether connection
     * to the other network succeeded.
     *
     * @return NetworkInfo
     */
    ...
    public enum State {
         ...
         * <ul>
         * <li>When connectivity is lost to one network, and there is no other available network
         * to attempt to switch to.
         * </li>
    ...
    private class ConnectivityBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            mNetworkInfo = (NetworkInfo) intent.getParcelableExtra(ConnectivityManager
                    .EXTRA_NETWORK_INFO);
            mOtherNetworkInfo = (NetworkInfo) intent.getParcelableExtra(ConnectivityManager
