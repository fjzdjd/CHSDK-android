 ...
 */
public abstract class JasonFragmentActivity extends FragmentActivity {

    private final static String LOG_TAG = "jason-fragment";
    ...
    private void goToThisFragment(FragmentParam param) {
        ...
        try {
            ...
            if (DEBUG) {
                Log.d(LOG_TAG, "before operate, stack entry count: %s" + fm
                        .getBackStackEntryCount());
            }
            JasonFragment fragment = (JasonFragment) fm.findFragmentByTag(fragmentTag);
            if (fragment == null) {
                fragment = (JasonFragment) cls.newInstance();
            }
    ...
    public void goToFragment(Class<?> cls, Object data) {
        ...
        JasonFragment fragment = (JasonFragment) getSupportFragmentManager().findFragmentByTag
                (cls.toString());
        if (fragment != null) {
            mCurrentFragment = fragment;
    ...
    private boolean tryToUpdateCurrentAfterPop() {
        ...
        if (cnt > 0) {
            ...
            if (fragment != null && fragment instanceof JasonFragment) {
                mCurrentFragment = (JasonFragment) fragment;
            }
            return true;
        }
        return false;
