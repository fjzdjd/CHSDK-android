 ...
 */
public abstract class JasonFragment extends Fragment implements IJasonFragment,
        IComponentContainer {
    ...
    /**
     * Implements{@link JTitleBaseFragment}
     * 自定义方法
     */
    protected abstract View createView(LayoutInflater inflater, ViewGroup container, Bundle
            savedInstanceState);

    public JasonFragmentActivity getContext() {
        return (JasonFragmentActivity) getActivity();
    }

    /**
     * ===========================================================
     * Implements {@link IJasonFragment}
     * ===========================================================
     */
    @Override
    ...
    private void showStatus(String status) {
        ...
        Log.d("lifecycle", "%s %s" + className[className.length - 1] + "," + status);
    }
